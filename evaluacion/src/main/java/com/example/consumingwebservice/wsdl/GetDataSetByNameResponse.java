...
@XmlRootElement(name = "GetDataSetByNameResponse", namespace = "http://tempuri.org")
public class GetDataSetByNameResponse {

    @XmlElement(name = "GetDataSetByNameResult", namespace = "http://tempuri.org", required = true)
