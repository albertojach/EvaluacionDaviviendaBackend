...
public class QueryByNameDataSet2 {

    @XmlElement(name = "QueryByName", namespace = "http://tempuri.org/QueryByName_DataSet")
    protected List<QueryByNameDataSet2 .QueryByName> queryByName;
     ...
     * {@link QueryByNameDataSet2 .QueryByName }
     * 
     * 
     */
    public List<QueryByNameDataSet2 .QueryByName> getQueryByName() {
        if (queryByName == null) {
            queryByName = new ArrayList<QueryByNameDataSet2 .QueryByName>();
        }
