...
@XmlRootElement(name = "DivideInteger", namespace = "http://tempuri.org")
public class DivideInteger {

    @XmlElement(name = "Arg1", namespace = "http://tempuri.org")
    protected Long arg1;
    @XmlElement(name = "Arg2", namespace = "http://tempuri.org")
    protected Long arg2;
